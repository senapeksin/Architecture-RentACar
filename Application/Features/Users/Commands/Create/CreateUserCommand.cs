...
internal class CreateUserCommand : IRequest<CreatedUserResponse>, ISecuredRequest
{
    ...
    public class CreateUserCommandHandler :  IRequestHandler<CreateUserCommand, CreatedUserResponse>
    {
        ...
        {
            await _userBusinessRules.UserEmailShouldNotExistsWhenInsert(request.Email); // kullanıcı emaili daha önce var olmamalı 
            User user = _mapper.Map<User>(request.Email);
